...
public class DeleteRecipientService {
    ...
    @Inject
    public DeleteRecipientService(DeleteRecipientRepository recipientRepository, CacheEvictionService cacheEvictionService, Validator validator) {
    ...
    public void deleteRecipient(@NotNull DeleteRecipientRequest deleteRecipientRequest) {
        ...
        cacheEvictionService.evictCacheEntriesByBankAccountId(bankAccountId);
    }
}